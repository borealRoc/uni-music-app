	...
	<view class="album-page">
		...
		<scroll-view scroll-y="true" class="page-content" @scroll="scrollpage">
					...
					<view class="flex-box">
						...
						<view class="info-con flex-item">
							...
							<view v-if="album.creator" class="avator-box flex-box">
								<image class="avator" v-if="album.creator.avatarUrl"
									:src="album.creator.avatarUrl+ $imgSuffix"></image>
			...
			<view class="album-list">
				...
				<view class="list">
					<view class="item flex-box" v-for="(item, index) in songList" :key="index"
...
<script>
	...
	export default {
		...
		computed: {
			...
			scrollBg() {
				if (this.album.coverImgUrl) {
					return 'background-image:url(' + (this.album.coverImgUrl + this.$imgSuffix) + ');top: ' + this
						.scrollTop + 'px'
				} else {
					return ''
				}
