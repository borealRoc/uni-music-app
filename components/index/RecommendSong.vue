<template>
	<view class="recommend-song">
		...
		<scroll-view class="scroll-view" scroll-x>
			<navigator class="item" v-for="(item, index) in recommendSongs" :key="index" hover-class="none"
				:url="'/pages/subpages/index/album?item='+ encodeURIComponent(JSON.stringify(item))">
